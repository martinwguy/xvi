 ...
 */
Param	params[] = {
/*  fullname        shortname    flags      value        function   pu */
{   "ada",          "ada",       P_BOOL,    0,           not_imp,   NULL },
{   "adapath",      "adap",      P_STRING,  0,           not_imp,   NULL },
{   "autodetect",   "ad",        P_BOOL,    0,           nofunc,    NULL },
{   "autogrow",     "ag",        P_BOOL,    TRUE,        nofunc,    NULL },
{   "autoindent",   "ai",        P_BOOL,    0,           nofunc,    NULL },
{   "autonoedit",   "an",        P_BOOL,    0,           nofunc,    NULL },
{   "autoprint",    "ap",        P_BOOL,    0,           not_imp,   NULL },
{   "autosplit",    "as",        P_NUM,     2,           nofunc,    NULL },
{   "autowrite",    "aw",        P_BOOL,    0,           not_imp,   NULL },
{   "beautify",     "bf",        P_BOOL,    0,           not_imp,   NULL },
{   "cchars",       "cc",        P_BOOL,    DEF_CCHARS,  nofunc,    NULL },
{   "colour",       "co",        P_STRING,  0,           xvpSetColour, NULL },
{   "directory",    "di",        P_STRING,  0,           not_imp,    NULL },
{   "edcompatible", "edc",       P_BOOL,    0,           not_imp,    NULL },
{   "edit",         "edi",       P_BOOL,    TRUE,        set_edit,   NULL },
{   "equalsize",    "eq",        P_BOOL,    TRUE,        nofunc,     NULL },
{   "errorbells",   "eb",        P_BOOL,    TRUE,        nofunc,     NULL },
{   "flash",        "flash",     P_BOOL,    FALSE,       xvpSetVBell, NULL },
{   "format",       "fmt",       P_ENUM,    0,           set_format, NULL },
{   "hardtabs",     "ht",        P_NUM,     0,           not_imp,    NULL },
{   "helpfile",     "hf",        P_STRING,  0,           nofunc,     NULL },
{   "ignorecase",   "ic",        P_BOOL,    0,           nofunc,     NULL },
{   "infoupdate",   "iu",        P_ENUM,    0,           nofunc,     NULL },
{   "jumpscroll",   "js",        P_ENUM,    0,           nofunc,     NULL },
{   "lisp",         "lisp",      P_BOOL,    0,           not_imp,    NULL },
{   "list",         "ls",        P_BOOL,    0,           nofunc,     NULL },
{   "magic",        "ma",        P_BOOL,    TRUE,        xvpSetMagic, NULL },
{   "mchars",       "mc",        P_BOOL,    DEF_MCHARS,  nofunc,     NULL },
{   "mesg",         "me",        P_BOOL,    0,           not_imp,    NULL },
{   "minrows",      "mi",        P_NUM,     2,           nofunc,     NULL },
{   "modeline",     "mo",        P_BOOL,    0,           not_imp,    NULL },
{   "number",       "nu",        P_BOOL,    0,           nofunc,     NULL },
{   "open",         "ope",       P_BOOL,    0,           not_imp,    NULL },
{   "optimize",     "opt",       P_BOOL,    0,           not_imp,    NULL },
{   "paragraphs",   "pa",        P_STRING,  0,           nofunc,     NULL },
{   "preserve",     "psv",       P_ENUM,    0,           nofunc,     NULL },
{   "preservetime", "psvt",      P_NUM,     5,           nofunc,     NULL },
{   "prompt",       "pro",       P_BOOL,    0,           not_imp,    NULL },
{   "readonly",     "ro",        P_BOOL,    0,           nofunc,     NULL },
{   "redraw",       "red",       P_BOOL,    0,           not_imp,    NULL },
{   "regextype",    "rt",        P_ENUM,    0,           xvpSetRT,   NULL },
{   "remap",        "rem",       P_BOOL,    TRUE,        nofunc,     NULL },
{   "report",       "rep",       P_NUM,     5,           nofunc,     NULL },
{   "roscolour",    "rst",       P_STRING,  0,           xvpSetColour, NULL },
{   "scroll",       "sc",        P_NUM,     0,           not_imp,    NULL },
{   "sections",     "sec",       P_STRING,  0,           nofunc,     NULL },
{   "sentences",    "sen",       P_STRING,  0,           nofunc,     NULL },
{   "shell",        "sh",        P_STRING,  0,           nofunc,     NULL },
{   "shiftwidth",   "sw",        P_NUM,     8,           nofunc,     NULL },
{   "showmatch",    "sm",        P_BOOL,    0,           nofunc,     NULL },
{   "slowopen",     "sl",        P_BOOL,    0,           not_imp,    NULL },
{   "sourceany",    "so",        P_BOOL,    0,           not_imp,    NULL },
{   "statuscolour", "st",        P_STRING,  0,           xvpSetColour, NULL },
{   "systemcolour", "sy",        P_STRING,  0,           xvpSetColour, NULL },
{   "tabindent",    "tabindent", P_BOOL,    TRUE,        nofunc,     NULL },
{   "tabs",         "tabs",      P_BOOL,    TRUE,        nofunc,     NULL },
{   "tabstop",      "ts",        P_NUM,     8,           xvpSetTS,   NULL },
{   "tagcolour",    "tc",        P_STRING,  0,           xvpSetColour, NULL },
{   "taglength",    "tlh",       P_NUM,     0,           tagSetParam, NULL },
{   "tags",         "tags",      P_LIST,    0,           tagSetParam, NULL },
{   "term",         "term",      P_STRING,  0,           not_imp,    NULL },
{   "terse",        "ters",      P_BOOL,    0,           nofunc,     NULL },
{   "timeout",      "ti",        P_NUM,     DEF_TIMEOUT, nofunc,     NULL },
{   "ttytype",      "tt",        P_STRING,  0,           not_imp,    NULL },
{   "undolevels",   "ul",        P_NUM,     MAX_UNDO,    set_undolevels, NULL },
{   "vbell",        "vb",        P_BOOL,    FALSE,       xvpSetVBell, NULL },
{   "warn",         "war",       P_BOOL,    TRUE,        nofunc,     NULL },
{   "window",       "wi",        P_NUM,     0,           not_imp,    NULL },
{   "wrapmargin",   "wm",        P_NUM,     0,           nofunc,     NULL },
{   "wrapscan",     "ws",        P_BOOL,    TRUE,        nofunc,     NULL },
{   "writeany",     "wa",        P_BOOL,    0,           not_imp,    NULL },

{   (char *) NULL,  (char *) NULL,  0,      0,           nofunc,     NULL },
